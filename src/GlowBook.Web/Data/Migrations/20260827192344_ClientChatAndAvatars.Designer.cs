...
namespace GlowBook.Web.Data.Migrations
{
    ...
    [Migration("20260827192344_ClientChatAndAvatars")]
    partial class ClientChatAndAvatars
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GlowBook.Web.Models.Entities.ClientAvatar", b =>
                {
                    ...
                    b.ToTable("ClientAvatars");
                });

            modelBuilder.Entity("GlowBook.Web.Models.Entities.ClientMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GlowBook.Web.Models.Entities.ClientAvatar", b =>
                {
                    b.HasOne("GlowBook.Web.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("GlowBook.Web.Models.Entities.ClientAvatar", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GlowBook.Web.Models.Entities.ClientMessage", b =>
                {
                    ...
                    b.HasOne("GlowBook.Web.Models.ApplicationUser", "SenderUser")
                        .WithMany()
